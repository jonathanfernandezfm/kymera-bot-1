...
module.exports = {
	...
	const embed_rangosadm = new EmbedBuilder()
      ...
      .setThumbnail('https://i.imgur.com/sxOHVjt.png') 
			.setDescription('<@&1015296284359413842> : Fundador de la guild, encargado de los asuntos internos y del asesoramiento de todos los permisos, roles y administración del gremio.')

    const embed_rangosadm1 = new EmbedBuilder()
			.setColor("#e7802c")
      .setThumbnail('https://i.imgur.com/l2yPJjA.png') 
			.setDescription('<@&1015942996455325719> : Los asesores del Guild Master, se encargan de los asuntos diarios del gremio. Trabajan en estrecha colaboración con el Consejo Warboss y el Guild Master para asegurar los objetivos de Kymera y con el tesorero para asegurar una economía estable.')

		const embed_rangosadm2 = new EmbedBuilder()
			.setColor("#f1c72e")
      .setThumbnail('https://i.imgur.com/cw5nnBE.png')
			.setDescription('<@&1015944979136389190> : Ejercen la función de liderazgo general, asegurándose de que todos se comporten correctamente y se diviertan, responder dudas y ayudar en el día a día.')

		const embed_rangosadm3 = new EmbedBuilder()
			.setColor("#ffff43")
			.setThumbnail('https://i.imgur.com/tLY5DVy.png')
			.setDescription('<@&1016011655957729331> : Gerentes financieros del gremio. El trabajo del tesorero es asegurarse de que la economía de Kymera está equilibrada de la mejor manera posible y así mismo, mantener las estructuras funcionales como Hideout y Territorios.')

		const embed_rangosadm4 = new EmbedBuilder()
			.setColor("#5969b5")
			.setThumbnail('https://i.imgur.com/P622nrg.png')
			.setDescription('<@&1016042360053973052> : Shotcaller con experiencia y conocimiento elevado en batallas de mundo abierto. Forman parte del concilio ZvZ y estrategia, y su función es liderar incursiones a castillos, ZvZ a media escala, magos, puestos avanzados...')

    const embed_rangosadm5 = new EmbedBuilder()
			.setColor("#9f6cb4")
			.setThumbnail('https://i.imgur.com/HGCEKS8.png')
			.setDescription('<@&1016042908257894460> : Se asegura de la administración de las solicitudes y de reclutar nuevos miembros. Revisan de que estos cumplan con los requisitos requeridos y que el proceso sea rápido y fluido.')
		...
		switch (interaction.values[0]) {
			case 'distribucion':
				return await interaction.reply({
					content: '',
					ephemeral: true,
					embeds: [embed_rangosadm, embed_rangosadm1, embed_rangosadm2, embed_rangosadm3, embed_rangosadm4, embed_rangosadm5, embed_rangosadm6],
				});
			case 'reparto':
				return await interaction.reply({
					content: '',
