...
module.exports = {
  ...
  execute: async (interaction) => {
    ...
    const embed_formulario = EmbedBuilder.from(previous_embed)
      .setColor('#FF4D4D')
      .setDescription(`❌ Denegado por el <@&1015296284359413842> - <@${interaction.user.id}>\nㅤ⠀⠀⠀⠀⠀⠀⠀\n`);
    ...
    const embed_response = new EmbedBuilder()
      .setColor('#fc0303')
      .setDescription('`❌` Tu solicitud ha sido denegada. No cumples con los requisitios, inténtalo en otro momento')
    ;
