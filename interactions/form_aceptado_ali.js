...
module.exports = {
    ...
    execute: async (interaction) => {
        ...
        const embed_formulario = EmbedBuilder.from(previous_embed)
            .setColor('#64FF64')
            .setDescription(
                `✅ Aceptado por el <@&1015296284359413842> - <@${interaction.user.id}> \nㅤ⠀⠀⠀⠀⠀⠀⠀\n`
            );
        ...
        const embed_response = new EmbedBuilder()
            .setColor('#64ff64')
            .setDescription(
                '`✅` **¡Enhorabuena, tu solicitud ha sido aceptada!** Nos pondremos en contacto contigo lo antes posible para seguir con el proceso.'
            );
